        ...
        if users.login(username, password):
            ...
            return render_template(
                    ...
                    message="Kirjautuminen epäonnistui. \
                             Tarkista, että käytät oikeaa tunnusta ja salasanaa.")
        ...
        if users.register(username, password, first_name, last_name):
            ...
            return render_template(
                    ...
                    message="Uuden käyttäjän luominen ei onnistunut. \
                             Syynä tähän voi olla varattu käyttäjänimi.")
...
def enroll_course(id):
    ...
    if courses.enroll_course(id):
        ...
        return render_template(
                "error.html", 
                message="Virhe liityttäessä kurssille. \
                         Oletko jo kurssilla?")
...
def new_course():
    ...
    if session["role"] not in ["teacher", "admin"]:
        return render_template(
                "error.html", 
                message="Sinulla ei ole oikeuksia lisätä kurssia.")
    if request.method == "GET":
    ...
    if request.method == "POST":
        ...
        if id != None:
            ...
            return render_template(
                    "error.html", 
                    message="Virhe luotaessa kurssia. \
